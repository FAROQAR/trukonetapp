...
<div class="content-wrapper">
    <section class="content" style="padding-top:10px;">
        <?= view('master/form/formservercore'); ?>
        <div id="servercorelist" class="card">
...
<!-- /.content-wrapper -->
<div id="servercoredetail-modal" class="modal">
    ...
    <div class="modal-content" style="width:400px;position: relative;margin: auto;">
        ...
        <div class="card card-warning" style="width:100%;height: 100%;position: relative;margin: auto;">
            <div class="card-header">
                <h3 id="servercoredetail-modal-title" class="card-title">Removable</h3>

                <div class="card-tools">
                    <button type="button" class="btn btn-tool">
                        <i class="fas fa-times"
                            onclick="document.getElementById('servercoredetail-modal').style.display = 'none'"></i>
                    </button>
                </div>
                <!-- /.card-tools -->
            </div>
...
<script src="<?= base_url(); ?>/assets/js/servercore.js">  
</script>
<script>
