      ...
      <div class="card-header">
        ...
        <div class="card-tools">
          <div class="input-group input-group-sm" style="width: 300px;">
            <button type="button" class="btn btn-primary btn-sm" id="btnloadsecret" onclick="loaddatasecret()" style="margin-right: 3px;">
              Load Secret
              <i class="fas fa-cogs"></i>

            </button>
            <input type="text" name="table_search" id="searchsecret" class="form-control float-right"
              placeholder="Search">
            <div class="input-group-append">
              <button type="button" class="btn btn-default" id="btnsearchsecret" onclick="cariSecretClick()">
      ...
      <div class="card-header">
        ...
        <div class="card-tools">
          <button type="button" class="btn btn-tool">
            <i class="fas fa-times" onclick="document.getElementById('secretdetail-modal').style.display = 'none'"></i>
          </button>
        </div>
        <!-- /.card-tools -->
      </div>
