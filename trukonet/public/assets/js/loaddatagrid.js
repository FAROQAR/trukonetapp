...
//                                alert("Detail: " + item.kode_bma);
                                var modal = document.getElementById("paketdetail-modal");
                                var judul = document.getElementById("paketdetail-modal-title");
...
//                            .append($customSwitchButton)
            ...
            {title: 'Id', name: 'idpaket', soritng: false, width: 20},
            {title: 'Keterangan', name: 'descpaket', soritng: false, width: 110},
            {title: 'Harga', name: 'harga', soritng: false, width: 110}
